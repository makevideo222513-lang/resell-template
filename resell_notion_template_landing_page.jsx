export default function ResellLandingPage() {
  const screenshots = [
    "/mnt/data/Screenshot 2026-05-10 150358.png",
    "/mnt/data/Screenshot 2026-05-10 150409.png",
    "/mnt/data/Screenshot 2026-05-10 150419.png",
    "/mnt/data/Screenshot 2026-05-10 150429.png",
    "/mnt/data/Screenshot 2026-05-10 150442.png",
  ];
    ...
    <div className="min-h-screen bg-black text-white font-sans">
      ...
      <section className="max-w-7xl mx-auto px-6 py-24">
        <div className="text-center mb-12">
          ...
          <h2 className="text-5xl font-black">실제 템플릿 화면</h2>
        </div>
        ...
        <div className="space-y-10">
          {screenshots.map((img, index) => (
            <div
              key={index}
              className="rounded-[32px] overflow-hidden border border-white/10 bg-white/[0.03] shadow-2xl"
            >
              <img
                src={img}
                alt={`template-${index}`}
